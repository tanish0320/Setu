...
export class UpdateDepartmentDto {
  ...
  @ApiPropertyOptional({ description: 'Department status', example: 'active' })
  @IsOptional()
  @IsString()
  status?: string;

  @ApiPropertyOptional({ description: 'ID of the hospital this department belongs to', example: '123e4567-e89b-12d3-a456-426614174000' })
  @IsOptional()
  @IsUUID()
  hospitalId?: string;
